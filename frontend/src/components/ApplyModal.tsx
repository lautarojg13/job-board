...
import { X, Send, Upload, FileText, CheckCircle2, AlertCircle, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-fadeIn">
      <div className="bg-slate-950 border border-slate-800 rounded-2xl max-w-lg w-full p-6 sm:p-8 text-slate-100 shadow-2xl relative">
        ...
        <div className="mb-6">
          <span className="text-xs font-bold text-sky-400 uppercase tracking-widest">Job Application</span>
