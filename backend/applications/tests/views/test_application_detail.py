...
class TestGetApplicationDetail:
    ...
    def test_get_application_detail_as_applicant(self, user, application):
        client = APIClient()
    ...
    @pytest.mark.django_db
    def test_get_application_detail_as_job_owner(self, user, user_2, job):
    ...
    @pytest.mark.django_db
    def test_get_application_detail_forbidden_to_unrelated_user(self, user_2, application):
        client = APIClient()
