...
class TestWithdrawApplication:
    ...
    def test_withdraw_application(self, user_2, testing_withdraw_application):
        client = APIClient()
    ...
    @pytest.mark.django_db
    def test_withdraw_application_forbidden_for_non_applicant(self, user, testing_withdraw_application):
        client = APIClient()
    ...
    @pytest.mark.django_db
    def test_withdraw_application_unauthenticated(self, testing_withdraw_application):
        client = APIClient()
        url = reverse("withdraw_application", kwargs={"application_id": testing_withdraw_application.id})
